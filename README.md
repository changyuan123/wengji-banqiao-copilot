...
專為 **翁記麻辣鍋－板橋店**（新北市板橋區篤行路三段 28 號）打造的單店 AI 行銷助手：讀板橋天氣 → 老闆自填營業狀況／目標 → 一鍵產出 LINE／社群文案。
...
- 老闆自填「今日營業狀況」與「今日營業目標」（可一鍵帶入常用範例再修改）
...
5. 用手機 Safari／Chrome 驗收：天氣、自填營業狀況／目標生成、複製 toast、訂閱導向綠界 stage
